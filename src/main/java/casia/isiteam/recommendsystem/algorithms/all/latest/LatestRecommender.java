...
public class LatestRecommender implements RecommendAlgorithm {
    ...
    private static final int Rec_Num = ConfigKit.getInt("LatestRecommendNum");
    ...
    public void recommend(List<Long> userIDs, int infoType) {
        ...
        for (Long userID : userIDs) {
            ...
            // 添加生成的推荐词条项
            latestItemsMap.get(infoType).forEach(itemID ->
    ...
    public static void formLatestItems() {
        ...
        for (Integer infoType : Recommender.infoTypes) {
            ...
            List<Long> latestItemIDs = DBKit.getLatestItemsByDateAndInfoType(infoType, Rec_Num);
